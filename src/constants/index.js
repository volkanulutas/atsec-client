...
export const API_URL_PACKING_PRODUCT = "/packingproduct/";
...
export const ADDPDF_BLOOD_RESULT = "ADDPDF_BLOOD_RESULT";
export const ADDPDF_PRE_CONFIRM = "ADDPDF_PRE_CONFIRM";
export const API_URL_PACKING_PRODUCT_BARCODE = "/packingproductbarcode/";
export const API_URL_DONOR_BARCODE = "/donorbarcode/";
