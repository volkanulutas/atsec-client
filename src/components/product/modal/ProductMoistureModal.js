...
import ProductMoistureState from "../state/ProductMoistureState";

class ProductMoistureModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default ProductMoistureModal;