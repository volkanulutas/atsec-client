...
class ProductService {
  getAllPackingProducts() {
    return axios.get(API_BASE_URL + API_URL_PRODUCT + "packing", {
      headers: authHeader(),
    });
  }

  getAllPreprocessingProducts() {
    return axios.get(API_BASE_URL + API_URL_PRODUCT + "preprocessing", {
      headers: authHeader(),
    });
  }
  ...
  createBarcode(id) {
    return axios.get(API_BASE_URL + API_URL_PRODUCT + "createbarcode/" + id, {
      headers: authHeader(),
    });
  }
  ...
  getWashingTypeList() {
    return axios.get(API_BASE_URL + API_URL_PRODUCT + "washingtypelist", {
      headers: authHeader(),
    });
  }
}
