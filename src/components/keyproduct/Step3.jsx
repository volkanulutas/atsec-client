...
const Step3 = (props) => {
  ...
  const [pdfFileError_Confirmation, setPdfFileError_Confirmation] =
    useState("");
      ...
      <FormGroup>
        <form className="form-group">
          ...
          <input
            ...
            required
            onChange={handlePdfFileChange_Confirmation}
          />
          {pdfFileError_Confirmation && (
            <div className="error-msg">{pdfFileError_Confirmation}</div>
          )}
          <br></br>
          <button
            onClick={handlePdfFileSubmit_Confirmation}
        ...
        <form className="form-group">
          ...
          <input
            ...
            className="form-control"
            required
            onChange={handlePdfFileChange_Transfer}
          />
          {pdfFileError_Transfer && (
            <div className="error-msg">{pdfFileError_Transfer}</div>
          )}
          <br></br>
          <button
            onClick={handlePdfFileSubmit_Transfer}
            className="btn btn-success btn-lg"
          >
            Yükle
          </button>
        ...
        <form className="form-group">
          ...
          <input
            ...
            className="form-control"
            required
            onChange={handlePdfFileChange_Extra}
          />
          {pdfFileError_Extra && (
            <div className="error-msg">{pdfFileError_Extra}</div>
          )}
          <br></br>
          <button
            onClick={handlePdfFileSubmit_Extra}
            className="btn btn-success btn-lg"
          >
            Yükle
          </button>
