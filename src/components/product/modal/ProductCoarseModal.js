...
import ProductCoarseState from "../state/ProductCoarseState";

class ProductCoarseModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <div>
        ...
        >
          <ModalHeader toggle={this.toggle}>Coarse</ModalHeader>
          <ModalBody>
            <ProductCoarseState
              errors={this.errors}
...
export default ProductCoarseModal;
