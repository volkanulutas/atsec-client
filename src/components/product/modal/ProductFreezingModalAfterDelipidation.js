...
import ProductFreezingStateAfterDelipidation from "../state/ProductFreezingStateAfterDelipidation";

class ProductFreezingModalAfterDelipidation extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default ProductFreezingModalAfterDelipidation;
