...
class ProductAfterWashingSterilationState extends Component {
  ...
  changePhValueHandler = (event) => {
    ...
    if (phValueFloat >= 6 && phValueFloat <= 7) {
      // 6 veya 7 arasında ise;
                ...
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name="phValue"
                      className={
                        this.hasError("phValue")
                          ? "form-control is-invalid"
                          : "form-control"
                      }
                      value={this.state.phValue}
                      onChange={this.changePhValueHandler}
                    />
                    <div
                      className={
                        this.hasError("phValue") ? "inline-errormsg" : "hidden"
                      }
                    >
                      PH değeri uygun değerde değil, PBS Yıkama işlemini
                      tekrarlayınız.
                    </div>
                  </div>
