...
import ProductPreprocessingState from "../state/ProductPreprocessingState";

class ProductPreprocessingModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default ProductPreprocessingModal;
